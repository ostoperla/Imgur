...
class SettingsFragment : BaseFragment<SettingsComponent>(R.layout.layout_container) {
    ...
    override fun createComponent() =
        Injector.findComponent<DrawerFlowComponent>().settingsComponentFactory().create()
    //endregion
}